...
from libMTF import create_mtf

POLICIES = ["best_quality", "early_valid", "late_valid"]


def generate_mtf_images(
    recordings_dir,
    n_dec=4,
    clip_stage_II=False,
    max_seg_min=10,
    policy="early_valid",
    images_dir="",
    images_index_file="mtf_images_index.json",
    show_signal=False,
    show_image=False,
    verbose=False,
    cmap=None,
...
def generate_mtf_images_segment(
    recordings_dir,
    n_dec=4,
    clip_stage_II=False,
    max_seg_min=10,
...
def generate_mtf_images_simple(
    recordings_dir,
    n_dec=4,
    clip_stage_II=False,
    max_seg_min=10,
